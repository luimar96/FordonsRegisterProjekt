...
namespace VehicleDomain.Vehicle
{
    public class LightWeightVehicle : IVehicle
    {
        ...
        public LightWeightVehicle(string registernumber, string brand, string model, float weight, DateTime firstTimeInTrafic, float yearlyFee, bool vehicleStatus, bool isServicebooked)
        {
        ...
        public LightWeightVehicle(string registernumber, string brand, string model, float weight, DateTime firstTimeInTrafic, bool vehicleStatus, float yearlyFee, string vehicletype,
