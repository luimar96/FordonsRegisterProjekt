...
{
    public class HeavyWeightVehilce : IVehicle
    {
        ...
        public HeavyWeightVehilce(string registernumber, string brand, string model, float weight, DateTime firstTimeInTrafic, float yearlyFee, bool vehicleStatus, bool isServicebooked)
        {
        ...
        public HeavyWeightVehilce(string registernumber, string brand, string model, float weight, DateTime firstTimeInTrafic, bool vehicleStatus, float yearlyFee, string vehicletype,
